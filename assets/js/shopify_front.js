                                    ...
                                    setTimeout(function(){
                                        ...
                                        if(getCookie("postcodeval") == undefined || getCookie("postcodeval") == ""){
                                            ...
                                            $(".price__container").append(
                                                '<div id="postalholder" style="line-height: 10px;align-items: center;display:flex;width: 300px;border-bottom:2px solid #f5db00;padding:10px 15px 0px 15px;margin-bottom:10px;">'+
