                                        ...
                                        '<div class="postalcode-popup">'+
                                            ...
                                            '<div class="postalcode-panel">'+
                                                ...
                                                '</div>'+
                                                    ...
                                                    ' </div>'+
                                                    '<div class="select_postman_block" style="display: none;"></select><select name="select_postman" class="postman_select" style="border-radius: 0;max-width: 100%;padding: 8px;width:140px;margin: 0 0 0 40.8%;display: flex;border:'+ comeback.outcome.zipcode_border_width +'px solid '+ comeback.outcome.color_zipcode_border +';border-radius:'+ comeback.outcome.zipcode_border_radius +'px;color:'+ comeback.outcome.color_zipcode_text +';background-color:'+ comeback.outcome.color_zipcode_button +';"></select></div>'+
                                                '</div>'+
