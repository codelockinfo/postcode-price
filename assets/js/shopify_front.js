...
include('https://code.jquery.com/jquery-3.6.0.min.js', function() {
    $(document).ready(function() {
        ...
        function check_app_status(){
            ...
            $(".product__price-container .price__regular .price-item,.price__container,.price-wrapper,.product-page-price-wrp,.product-price,.t4s-product__price-review,.f8pr .f8pr-price,.product-single__prices,.product-single__meta .product__price,.ProductMeta__PriceList,.price-review,.product__price__wrap .product__price span,.price-list sale-price,.price__regular .price-item--regular").css("display","none");
                $.ajax({
                    ...
                    success: function (comeback) {
                        ...
                        if (comeback['code'] != undefined && comeback['code'] == '403') {
                            ...
                            if(comeback['data'] == '1'){
                                    ...
                                    if(window.location.href.includes("/products/")){
                                        ...
                                        setTimeout(function(){
                                            ...
                                            if(getCookie("postcodeval") == undefined || getCookie("postcodeval") == ""){
                                                ...
                                                $(".product__price-container,.price-wrapper,.product-page-price-wrp,.product-price,.t4s-product__price-review,.f8pr .f8pr-price,.product-single__prices,.product-single__meta .product__price,.ProductMeta__PriceList,.price-review,.product__price__wrap,.price--show-badge,.price-area,#product-price").append(
                                        ...
                                        $(document).on("click","form button[type='submit'],form input[type='submit']",function (ent) {
                                            ent.preventDefault();
                                ...
                                $(".product__price-container .price__regular .price-item,.price__container,.price-wrapper,.product-page-price-wrp,.product-price,.t4s-product__price-review,.f8pr .f8pr-price,.product-single__prices,.product-single__meta .product__price,.ProductMeta__PriceList,.price-review,.product__price__wrap .product__price span,.price-list sale-price,.price__regular .price-item--regular").css("display","block");
                    ...
                    success: function (comeback) {
                        if (comeback['code'] != undefined && comeback['code'] == '403') {
                                ...
                                if(getCookie("postcodeval") != undefined || getCookie("postcodeval") != "" ){
                                    ...
                                    $(".product__price-container .price__regular .price-item,.price__container,.price-wrapper,.product-page-price-wrp,.product-price,.t4s-product__price-review,.f8pr .f8pr-price,.product-single__prices,.product-single__meta .product__price,.ProductMeta__PriceList,.price-review,.product__price__wrap .product__price span,.price-list sale-price,.price-area,.price__regular .price-item--regular").css("display","block");
                                    setTimeout(function(){
                                        $(".product__price-container .price__regular .price-item,.price__container,.price-wrapper,.product-page-price-wrp,.product-price,.t4s-product__price-review .t4s-product-price,.f8pr .f8pr-price,.product-single__prices,.product-single__meta .product__price,.ProductMeta__PriceList,.price-review,.product__price__wrap .product__price span,.price-list sale-price,.product-page-info__price .price span,.price-area .current-price,.price__regular .price-item--regular").html($currecySymbol[0]+" "+$newPrice);
                                        ...
                                        if($hasClasspostalholder == undefined){
                                            $(".product__price-container,.price-wrapper,.product-page-price-wrp,.product-price,.t4s-product__price-review,.f8pr .f8pr-price,.product-single__prices,.product-page-info__price,.product-single__meta .product__price,.ProductMeta__PriceList,.price-review,.product__price__wrap,.price--show-badge,.price-area,#product-price").append(
                                                '<div id="postalholder" style=" display:flex;width: 300px;border-bottom:2px solid #f5db00;padding:10px 15px 0px 15px;margin-bottom:10px;justify-content:space-between;>'+
                                                ' <p class="pmessage">'+getCookie("postcodeval")+'<i class="icon-ok" style="color:#5b9b30;"></i>'+getCookie("postcodename")+'</p> '+  
                                                    '<div class="clsremovezipcode" style="width: 30px;cursor: pointer;"><svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/5000/svg"><path fill="currentColor" d="M352 192V95.936a32 32 0 0 1 32-32h256a32 32 0 0 1 32 32V192h256a32 32 0 1 1 0 64H96a32 32 0 0 1 0-64h256zm64 0h192v-64H416v64zM192 960a32 32 0 0 1-32-32V256h704v672a32 32 0 0 1-32 32H192zm224-192a32 32 0 0 0 32-32V416a32 32 0 0 0-64 0v320a32 32 0 0 0 32 32zm192 0a32 32 0 0 0 32-32V416a32 32 0 0 0-64 0v320a32 32 0 0 0 32 32z"/></svg></div>'+
                                                '</div>');
                                    ...
                                    $(".product__price-container .price__regular .price-item,.price__container,.price-wrapper,.product-page-price-wrp,.product-price,.t4s-product__price-review,.f8pr .f8pr-price,.product-single__prices,.product-single__meta .product__price,.ProductMeta__PriceList,.price-review,.product__price__wrap .product__price span,.price-list sale-price,.price-area,.price__regular .price-item--regular").css("display","none");
                                }
