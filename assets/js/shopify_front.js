                                ...
                                $(".single-option-selector").addClass("clssingle-option-selector");
                                    ...
                                    setTimeout(function(){
                                        ...
                                        if(getCookie("postcodeval") == undefined || getCookie("postcodeval") == ""){
                                            ...
                                            $(".product__price-container,.price__container,.price-wrapper,.product-page-price-wrp,.product-price,.t4s-product__price-review,.f8pr .f8pr-price,.product-single__prices,.product-page-info .product-page-info__price,.product-single__meta .product__price,.ProductMeta__PriceList,.price-review,.product__price__wrap").append(
