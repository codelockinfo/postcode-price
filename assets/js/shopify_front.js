...
$(document).ready(function() {
    ...
    function  hasbuynowbtn(){
        ...
        if($hasfindclass == true){
            ...
            $(".product-form__buttons,.ProductForm,.product__submit__buttons,.payment-buttons,.dynamic-checkout,.buy-buttons .shopify-payment-button,.t4s-product-form__buttons .shopify-payment-button,.product__cart-functions .flex-buttons,form .shopify-payment-button").append($payment_btn_Html);
